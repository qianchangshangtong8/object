...
public class DeleteUser extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		out.println("alert('删除失败!');history.back();");
		out.println("</script>");
		out.flush();
		out.close();
	}
