...
public class SetSuperManager extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			ps.close();
			con.close();
			session.setAttribute("modifyUserPowermsg","设置该用户为超级管理员成功!");
	    	...
	    	System.out.print("设置管理员资格失败");
	    }
	    out.println("<script language=javascript>");
		out.println("alert('设置失败!');history.back();");
		out.println("</script>");
		out.flush();
		out.close();
	}
