...
-->
 ...
 <body>
  ...
  <div id="content">
    <p>&nbsp;</p>
    <p class="STYLE6">“雨雨风风年年岁岁人相同， <br>
      </p>
    <p class="STYLE6">花花叶叶朝朝暮暮梦不变。” ——题记。 <br>
    </p>
    <p class="STYLE6">&nbsp;</p>
    <p class="STYLE6">那个诗意绵绵的秋季， <br>
    </p>
    <p class="STYLE6">那一颗颗搂着同样期盼的心， <br>
      </p>
    <p class="STYLE6">在广工这片沃土上聚在一起。 <br>
      </p>
    <p class="STYLE6">倚着闪耀的晨曦， <br>
      </p>
    <p class="STYLE6">我们用信念织出梦想的羽翅， <br>
      </p>
    <p class="STYLE6">在日新月异的网络世界里， <br>
      </p>
    <p class="STYLE6">翱翔天际!<br>
      </p>
    <p class="STYLE6">没错,就是皇家学府学长！</p>
    <p>&nbsp;</p>
	</div>
  <div id="footer">
      <p align="center">
      ...
      <p align="center" class="STYLE1">Copyright GDUPT 谢甲山</p>
  </div>
  </div>
</body>  
</html>