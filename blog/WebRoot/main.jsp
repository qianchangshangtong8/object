...
var sysBBS="<span style='font-size:14px; line-height:30px;'>欢迎光临博客在线聊天室，请遵守聊天室规则，不要使用不文明用语。</span><br><span style='line-height:22px;'>";
...
<script type="text/javascript" >
  ...
  $(document).ready(function(){
	...
	margin:0 auto;
	position:relative;
	background-image:url(image/bg22.jpg);
	}
	#topimg .hhh{
	position:absolute;
	top:90px;
...
<body>
<!-- <table width="960" height="150" border="0" align="center" cellpadding="0" cellspacing="0" background="image/bg22.jpg">
  <tr>
    <td>范德萨付付付付防撒旦法</td>
  </tr>
</table> -->
...
<div id="topimg">
<h1 class="hhh blink">博客在线交流平台</h1>

</div>



<table width="960" height="276" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
...
<table width="960" height="95" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#D6D3CE" background="image/bg11.jpg">
...
说：</td>
  ...
  <tr>
    ...
    <input name="content1" type="textarea" cols="70" rows="5" size="70" onKeyDown="if(event.keyCode==13 && event.ctrlKey){send();}">
      <input name="Submit2" type="button" class="btn_grey button" value="发送" onClick="send()"></td>
    <td align="right"><input name="button_exit" type="button" class="btn_grey button blue" value="退出聊天室" onClick="Exit()"></td>
    <td align="center">&nbsp;</td>
  </tr>
  <tr>
    <td height="30" align="left">&nbsp;</td>
    <td colspan="2" align="center" class="word_dark">&nbsp;博客在线聊天室</td>
    <td align="center">&nbsp;</td>
  </tr>
</form>
</table>
