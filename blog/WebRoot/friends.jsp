...
function resetText(fname){
  ...
  <div id="searchf">
    <form action="FriendsSearch?username=<%=currentusername %>" method="post" onSubmit="return isRight(this);">
       <span><font size="4" color="#113359">查找好友</font></span>
        <input type="text" name="friendsname" value="在这输入用户名" onFocus="resetText(this)" style="width:120px;height:30px"/>
  ...
  <table height="45px" align="center">
    ...
    <div id="friendslist">
    	<h1 ><font color="#113359">你当前的好友:</font></h1>
       <table align="center" width="1200px" class="datagridstyle" id="DataGrid1" cellSpacing=0 cellPadding=3 border=0>
