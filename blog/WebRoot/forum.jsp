...
<body>
  ...
  if(currentusername.equals(username)&&!("".equals(currentusername))){
   %>
  <div id="clear">
    <a href="forum_send.jsp?username=<%=currentusername %>" class="button">发布博客</a>
  </div>
  <%} %>
     ...
     <tr class="datagridhead">
      ...
      <tr>
        <td align='right'>
          ...
          %>
           <a href="forum_modify.jsp?serial=<%=strserial %>&&username=<%=currentusername %>" class="button">修改文章</a>
           <a href="DeleteArticleDAO?currentusername=<%=currentusername %>&&article_no=<%=strserial %>" onClick="return confirm('是否要删除该文章?');" class="button">删除文章</a>
           <%}%>
        </td>
      </tr>
      <tr>
...
<script type="text/javascript">
    ...
    //UE.getEditor('myEditor')
        ...
        <tr>
         <td><input type="submit" class="button"  size="10" value="回  复"/></td>
        </tr>
      </table>
