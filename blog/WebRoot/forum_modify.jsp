...
<!--         <iframe style="border: none" name="cnEditBox" src="editbox/editbox.htm" width="100%" height="400"> </iframe> 
 -->      
<%--  		<input type="text" name="content" value="<%=art.getContent() %>">
 --%> 		
<%--  <textarea rows="10" cols="80" value="<%=art.getContent()%>" name="content"><%=art.getContent()%></textarea>
 --%>


<script type="text/plain" id="myEditor" name="content"><%=art.getContent()%></script>
