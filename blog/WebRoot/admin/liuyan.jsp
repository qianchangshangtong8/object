...
function isOK(f)
{
  ...
  <body>
    ...
    <table height="30px" align="center">
         ...
         <table align="center" width="960px" id="liuyanshow" cellSpacing=0 cellPadding=3 border=0 style="margin-top:30px;">
 <%
        ...
        <tr class="datagridhead">
          <td>
	        ...
	        <a href="../newliuyan.jsp" target="_blank" style="color:blue;">回复留言</a>
          </td>
         </tr>
         <tr>
          <td>
