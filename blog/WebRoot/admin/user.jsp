...
<%
  ...
  //String eusername = new String(username.getBytes("utf-8"),"ISO8859_1");
...
<p>本站已有的 <select name="type" id="selecttype" onchange="loadType();">
    ...
    <table align="center" width="1200px" height="390px" class="datagridstyle" id="DataGrid1" cellSpacing=0 cellPadding=3 border=0>
     ...
     <%
      ...
      <td text-align="center"><a href="adminforum.jsp?username=<%=userdata.getName() %>&numberpage=3"><%=userdata.getSendArticle() %> 篇</a></td>
      <td><%=userdata.getRegeditTime() %></td>
      <td>
        <%
         if(!userdata.getPower().equals("1111")&&!userdata.getPower().equals("111")){
